...
HD_PWD='D:/XilinxProjekty/Prescaler/Prescaler.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Prescaler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Prescaler.tcl -notrace
